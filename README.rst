...
reference manager. It will automatically generate citation keys by ``Author_
Year_Journal_Abbreviation`` format. For example, for the following citation:
